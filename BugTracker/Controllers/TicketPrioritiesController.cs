...
namespace BugTracker.Controllers
{
    public class TicketPrioritiesController : Controller
    {
        ...
        {
            return View(TicketPriorityHelper.GetTicketPrioritys());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            TicketPriority ticketPriority = TicketPriorityHelper.GetTicketPriority(id);
        ...
        public ActionResult Create([Bind(Include = "Id,Name")] TicketPriority ticketPriority)
        {
            ...
            {
                TicketPriorityHelper.Create(ticketPriority.Name);
        ...
        public ActionResult Edit([Bind(Include = "Id,Name")] TicketPriority ticketPriority)
        {
            if (ModelState.IsValid)
            {
                TicketPriorityHelper.Edit(ticketPriority.Id, ticketPriority.Name);
                return RedirectToAction("Index");
            }
            return View(ticketPriority);
        }
        ...
        {
            TicketPriorityHelper.Delete(id);
            return RedirectToAction("Index");
        }
    }
}
